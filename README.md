...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-moon-f716
```

A live public deployment of this template is available at [https://delicate-moon-f716.templates.workers.dev](https://delicate-moon-f716.templates.workers.dev)
